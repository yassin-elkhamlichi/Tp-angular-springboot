...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{harvardcrimson}{\textbf{CS-E4200}} --- Smart Inventory Platform}
\fancyhead[R]{\small\textcolor{gray}{Harvard SEAS}}
\fancyfoot[C]{\thepage}
...
\titleformat{\chapter}[display]
    {\normalfont\huge\bfseries\color{harvardcrimson}}
...
{\Huge\textcolor{harvardcrimson}{\textbf{HARVARD UNIVERSITY}}}\\[0.3cm]
{\large School of Engineering and Applied Sciences}\\[2cm]
...
\begin{tabular}{rl}
\textbf{Course:} & CS-E4200 --- Modern Full-Stack Web Engineering \\[0.3cm]
\textbf{Professor:} & Dr. Y. Elkhamlichi \\[0.3cm]
\textbf{Semester:} & Fall 2026 \\[0.3cm]
\textbf{Duration:} & 6 Weeks (2h/day) \\
\end{tabular}

\vfill

\begin{tcolorbox}[colback=harvardcrimson!5, colframe=harvardcrimson, arc=5mm, boxrule=1.5pt, width=0.85\textwidth]
\centering
...
\textcopyright\ 2026 Harvard University --- School of Engineering and Applied Sciences
\end{center}
